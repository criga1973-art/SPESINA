...
### Task Tecnici:
- [x] **Dati Cliente**: Implementare il recupero automatico dell'email del cliente durante il `finishOrder`.
- [x] **Template HTML**: Creare un template email "Premium" con:
...
- [x] **Edge Function**: Aggiornare la funzione `send-welcome` su Supabase per gestire il nuovo tipo di email `RECEIPT`.
