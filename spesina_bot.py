...
CAT_MAP = {
    ...
    "snack-salati": {"n": "Snack Salati", "sub": ["Patatine", "Salatini", "Altro"]},
    "snack-dolci": {"n": "Snack Dolci", "sub": ["Biscotti", "Merendine", "Altro"]},
    "senza-glutine": {"n": "Senza Glutine", "sub": ["Senza Glutine"]},
    "parafarmacia": {"n": "Parafarmacia", "sub": ["Parafarmacia"]},
